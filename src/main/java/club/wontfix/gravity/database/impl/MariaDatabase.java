...
public class MariaDatabase implements Database {
    ...
    public void setup() throws SQLException {
        update("CREATE TABLE IF NOT EXISTS `gravity` (" +
                "name VARCHAR(64), uniqueID VARCHAR(64), verifyID VARCHAR(64), machineName VARCHAR(64), dev BOOLEAN, killSwitched BOOLEAN" +
                ");");
        update("CREATE TABLE IF NOT EXISTS `queue` (name VARCHAR(64), verifyID VARCHAR(64), dev BOOLEAN);");
    }
